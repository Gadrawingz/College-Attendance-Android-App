...
public class DashboardDoq extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard_doq);
        ...
        if(SharedPrefManager.getInstance(this).isLoggedIn()) {
            findViewById(R.id.viewMenus).setOnClickListener(v -> {
                ...
                Intent i = new Intent(DashboardDoq.this, StaffMenus.class);
            ...
            findViewById(R.id.viewProfile).setOnClickListener(v -> {
                String sentWord = activeRole;
                Intent i = new Intent(DashboardDoq.this, ProfileActivity.class);
                i.putExtra("sent_role", sentWord);
                startActivity(i);
            });

        } else {
            Intent intent = new Intent(DashboardDoq.this, LoginActivity.class);
        ...
        logoutButton.setOnClickListener(v -> {
            ...
            Intent i = new Intent(DashboardDoq.this, MainActivity.class);
            startActivity(i);
        });
    }
