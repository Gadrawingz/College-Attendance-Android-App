...
public class StaffActivity extends AppCompatActivity {
    ...
    private void transferDataUsingVolley(String FN, String LN, String EM, String PH, String GD, String RL, String PS) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.STAFF_REGISTER, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(StaffActivity.this, error.toString(), Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
