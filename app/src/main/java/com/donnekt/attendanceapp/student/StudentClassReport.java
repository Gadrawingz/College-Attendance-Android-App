...
public class StudentClassReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_class_report);

        lvStudentsList = findViewById(R.id.lvStudentsList);
        mainTitle=findViewById(R.id.mainTitle);
        //totalCountsAbsent = findViewById(R.id.totalCountsAbsent);
        //totalCountsPresent = findViewById(R.id.totalCountsPresent);

        ///totalCountsAbsent.setText("...");
        //totalCountsPresent.setText("...");
        ...
        mainTitle.setOnClickListener(v -> {
            Intent g = new Intent(getApplicationContext(), ModulesLecturerRep.class);
            g.putExtra("lecturer_id_key", "");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URLs.STUD_CLASS+FINAL_CLASS_ID, response -> {
            ...
            try {
                ...
                for(int i=0; i<staffArray.length(); i++) {
                    ...
                    StClassReportAdapter adapter = new StClassReportAdapter(studentList, getApplicationContext());
